...
## True-True Collage
Now back up, I know what you're thinking. What even *is* a True-True collage? Are we doing tests now? Why are there conditions to collage? While I wouldn't call this a style of collage, I would rather describe this as a way of how the collage is being formed. This may sound like I'm complicating things (which I am) but this has been in my head for way too long, and I want to get it out as we end this page. 

Now as you and I would both know at this point, collage is basically when two, three, or more objects from different pictures or artworks come together. This is always true. But how do they come together?
...
## False-True Collage
If the previous example sounds weird as to why it needed to be presented, I want to describe the False-True collage next. 
